...
DRIVE_FOLDER_ID  = "1zuBnVSMPjICnPsPESObOiUq_L0cYzlDa"  # Folder "Jurnal Keuangan Users"
...
def daftarkan_user(chat_id: str, nama: str):
    ...
    # 1. Copy template ke folder "Jurnal Keuangan Users" di Drive pemilik
    ...
    resp = req.post(
        ...
        json={
            "name": copy_title,
            "parents": [DRIVE_FOLDER_ID]  # Simpan ke folder milik owner, bukan service account
        }
    )
